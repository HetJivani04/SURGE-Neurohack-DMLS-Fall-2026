# REAL_sota_stats_n83_entropy gap columns + SOTA stats

- claim: **task_sota_reliability** — scan-rescan reliability CIs exclude 0 vs noalign/BrainSync/FUGW; identification **withdrawn** (same-map protocol map-invariant — fitted / Haar-random / permuted all 83/83; see RESULTS.md §5b).
...
|---|---:|---:|---:|---:|---:|
| ours_full_posterior_shrink | 1.0000 | 0.6975 | -0.0349 | 0.0345 | nan |
...
| FUGW (OT) | — | — | — | silent |
| conn_srm | — | — | — | silent |
| ours_full_posterior_shrink | — | nan | n_eff=nan < S; ci_ratio=1.0756808589383464; high_tau_p90=9 | emits τ_φ + REML weights |
